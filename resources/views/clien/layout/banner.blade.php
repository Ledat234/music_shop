            ...
            <div class="row">
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img style="border-radius: 10%" src="{{ asset('assets/images/category/jazz.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img style="border-radius: 10%" src="{{ asset('assets/images/category/edm.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img style="border-radius: 10%" src="{{ asset('assets/images/category/dance.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img style="border-radius: 10%" src="{{ asset('assets/images/category/bolero.png') }}" alt="Category image">
                            </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                            <span>
                                <img style="border-radius: 10%" src="{{ asset('assets/images/category/rock.png') }}"alt="Category image">
                            </span>
                        </figure>
